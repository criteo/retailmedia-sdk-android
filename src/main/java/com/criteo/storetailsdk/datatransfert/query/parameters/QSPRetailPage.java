...
public class QSPRetailPage extends StoQueryStringParam {

    private String name;
    private String value;

    public QSPRetailPage(Context context, String value) {
        this.name = context.getString(R.string.sto_qsp_retail_page);
        this.value = value;
    }

    public QSPRetailPage(Context context) {
        this.name = context.getString(R.string.sto_qsp_retail_page);
    }
