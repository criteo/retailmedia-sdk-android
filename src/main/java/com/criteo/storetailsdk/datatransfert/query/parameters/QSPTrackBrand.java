...
public class QSPTrackBrand extends StoQueryStringParam {

    private String name;
    private String value;

    public QSPTrackBrand(Context context, String value) {
        this.name = context.getString(R.string.sto_qsp_track_brand);
        this.value = value;
    }

    public QSPTrackBrand(Context context) {
        this.name = context.getString(R.string.sto_qsp_track_brand);
    }
