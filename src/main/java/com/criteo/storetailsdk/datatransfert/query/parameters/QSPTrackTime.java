...
public class QSPTrackTime extends StoQueryStringParam {

    private String name;
    private String value;

    public QSPTrackTime(Context context, String value) {
        this.name = context.getString(R.string.sto_qsp_track_time);
        this.value = value;
    }

    public QSPTrackTime(Context context) {
        this.name = context.getString(R.string.sto_qsp_track_time);
    }
