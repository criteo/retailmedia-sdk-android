...
public class QSPTrackFrom extends StoQueryStringParam {

    private String name;
    private String value;

    public QSPTrackFrom(Context context, String value) {
        this.name = context.getString(R.string.sto_qsp_track_from);
        this.value = value;
    }

    public QSPTrackFrom(Context context) {
        this.name = context.getString(R.string.sto_qsp_track_from);
    }
