...
public class QSPTrackValue extends StoQueryStringParam {

    private String name;
    private String value;

    public QSPTrackValue(Context context, String value) {
        this.name = context.getString(R.string.sto_qsp_track_value);
        this.value = value;
    }

    public QSPTrackValue(Context context) {
        this.name = context.getString(R.string.sto_qsp_track_value);
    }
