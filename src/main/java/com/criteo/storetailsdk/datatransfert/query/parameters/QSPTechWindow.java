...
public class QSPTechWindow extends StoQueryStringParam {

    private String name;
    private String value;

    public QSPTechWindow(Context context, String value) {
        this.name = context.getString(R.string.sto_qsp_tech_window);
        this.value = value;
    }

    public QSPTechWindow(Context context) {
        this.name = context.getString(R.string.sto_qsp_tech_window);
    }
