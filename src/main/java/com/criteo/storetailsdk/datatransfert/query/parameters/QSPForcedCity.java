...
public class QSPForcedCity extends StoQueryStringParam {

    private String name;
    private String value;

    public QSPForcedCity(Context context, String value) {
        this.name = context.getString(R.string.sto_qsp_forced_city);
        this.value = value;
    }

    public QSPForcedCity(Context context) {
        this.name = context.getString(R.string.sto_qsp_forced_city);
    }
