...
/**
 * A helper class to enable automatically resizing {@link Button}`s {@code textSize} to fit
 * within its bounds.
 *
...
public class StoAutoFitHelper {
     ...
     */
    public static StoAutoFitHelper create(Button view) {
     ...
     * automatically sizing the text to fit.
     */
    public static StoAutoFitHelper create(Button view, AttributeSet attrs) {
     ...
     * automatically sizing the text to fit.
     */
    public static StoAutoFitHelper create(Button view, AttributeSet attrs, int defStyle) {
        StoAutoFitHelper helper = new StoAutoFitHelper(view);
    ...
    private StoAutoFitHelper(Button view) {
     ...
     */
    public StoAutoFitHelper addOnTextSizeChangeListener(OnTextSizeChangeListener listener) {
        if (mListeners == null) {
     ...
     */
    public StoAutoFitHelper removeOnTextSizeChangeListener(OnTextSizeChangeListener listener) {
        if (mListeners != null) {
     ...
     */
    public StoAutoFitHelper setPrecision(float precision) {
     ...
     */
    public StoAutoFitHelper setMinTextSize(float size) {
     ...
     * @attr ref me.grantland.R.styleable#AutofitTextView_minTextSize
     */
    public StoAutoFitHelper setMinTextSize(int unit, float size) {
     ...
     */
    public StoAutoFitHelper setMaxTextSize(float size) {
     ...
     * @attr ref android.R.styleable#TextView_textSize
     */
    public StoAutoFitHelper setMaxTextSize(int unit, float size) {
        Context context = mButtonView.getContext();
        Resources r = Resources.getSystem();
     ...
     */
    public StoAutoFitHelper setMaxLines(int lines) {
        if (mMaxLines != lines) {
            mMaxLines = lines;
     ...
     */
    public StoAutoFitHelper setEnabled(boolean enabled) {
        if (mEnabled != enabled) {
            mEnabled = enabled;
